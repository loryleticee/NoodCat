...
class Client extends \App\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'id_card', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'firstname', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'lastname'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdCard(string $id_card): \App\Entity\Client
    {
